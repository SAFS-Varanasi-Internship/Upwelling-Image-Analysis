...
* Monthly SST from ERA5 global reanalysis 0.25 deg grid; Daily SST for NOAA IOSST AVHRR-only 0.25 deg grid.
...
**Daily** SST from the NOAA IOSST AVHRR-only data set.
