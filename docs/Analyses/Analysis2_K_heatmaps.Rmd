...
myheatmap(dend, out_kmeans, main.n=main.n, sub.n=n_K, ramp="var", ramp.type=2)
}
```
...
```{r}
kheatmap(6, X_norm, Data_dirty)
```

### K=8

```{r}
kheatmap(8, X_norm, Data_dirty)
```

### K=10

```{r}
kheatmap(10, X_norm, Data_dirty)
```

### K=12

```{r k12}
kheatmap(12, X_norm, Data_dirty)
```

### K=14

```{r k14}
kheatmap(14, X_norm, Data_dirty)
```

### K=16

```{r k16}
kheatmap(16, X_norm, Data_dirty)
```

### K=18

```{r k18}
kheatmap(18, X_norm, Data_dirty)
```

### K=20

```{r k20}
kheatmap(20, X_norm, Data_dirty)
```

### K=22

```{r k22}
kheatmap(22, X_norm, Data_dirty)
```

### K=25

```{r k25}
kheatmap(25, X_norm, Data_dirty, main.n=6)
```

### K=30

```{r k30}
kheatmap(30, X_norm, Data_dirty, main.n=6)
```
